...
/** Coordinates the pure offseason transition. UI, finance and persistence remain outside. */
class OffseasonManager(
    ...
    private val franchiseStrategyManager: FranchiseStrategyManager = FranchiseStrategyManager()
) {
    data class Activity(
        val cpuTrades: Int = 0,
